          ...
          >
            <div className="futuristic-card p-8 mb-8">
              ...
              <div className="space-y-3">
                ...
                <p className="text-gray-400">
                  <span className="text-[#00ff00]">🏠</span> From: Jose Panganiban, Camarines Norte, Bicol
                </p>
                <p className="text-gray-400">
                  <span className="text-[#00ff00]">📍</span> Currently in: Sta Mesa, Manila
                </p>
                <p className="text-gray-400">
                  <span className="text-[#00ff00]">🎓</span> Technological Institute of the Philippines Manila
                </p>
                <p className="text-gray-400">
                  <span className="text-[#00ff00]">💼</span> Computer Engineering Student (2nd Year)
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 gap-4">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  className="futuristic-card p-4 flex items-center justify-center group cursor-pointer"
                >
                  <social.icon 
