              ...
              <div className="space-y-4">
                {education.map((edu, index) => (
                  ...
                  >
                    ...
                    {edu.program && (
                      <p className="text-gray-500 text-xs italic">{edu.program}</p>
                    )}
                  </motion.div>
                ))}
              </div>
            ...
            <div className="futuristic-card p-8 h-full">
              ...
              <div className="space-y-4">
                {achievements.map((achievement, index) => (
                  ...
                  >
                    <p className="text-[#00ff00] mb-1">{achievement.title}</p>
              ...
              <div className="space-y-3">
                {seminars.map((seminar, index) => (
                  ...
                  >
                    ...
                    <p className="text-gray-300 group-hover:text-[#00ff00] transition-colors duration-300">{seminar}</p>
                  </motion.div>
                ))}
              </div>
            </div>
